...
let c = new Array(5) // 요소가 없고 길이가 5인 배열로 시작한다.
c.fill(0) // => [0, 0, 0, 0, 0] 배열을 0으로 채운다.
c.fill(9, 1) // => [0, 9, 9, 9, 9] 인덱스 1에서 시작해 9로 채운다.
c.fill(8, 2, -1) // => [0, 9, 8, 8, 9] 인덱스 2에서 시작해 3까지 8로 채운다.
